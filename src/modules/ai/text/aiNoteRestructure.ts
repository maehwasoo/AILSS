...
텍스트 재구조화 원칙:
- 주제와 핵심 개념은 명확한's 헤더로 구분하여 체계적으로 조직화
- 핵심 20%의 정보에 집중하되, 주요 개념을 풍부하고 자세하게 설명
...
위 정보를 바탕으로, 파레토 법칙에 따라 주제("${title}")의 핵심 내용에 집중하여 다양한 마크다운 형식을 활용해 체계적이고 논리적인 구조로 내용을 생성해주세요.`;
